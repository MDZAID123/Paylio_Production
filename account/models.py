...
class Account(models.Model):
    ...
    # logic whenever a user get deleted we want to delete the account
    ...
    # we also need to account status
...
class KYC(models.Model):
    # we are trying to make this model inherit certain properties of the django
    ...
    # finally we will return a string representation of object 
    def __str__(self):
        return f"{self.user}"
...
# Finally connects everything using Django signal post
# the main logic here is that whenever a user signs up abank account object should be automatically created 
